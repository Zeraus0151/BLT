...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2019 a las 18:43:59
...
--
ALTER TABLE `noticias`
  MODIFY `idnoticias` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
