...
?>
			...
			<article>
				...
				<div>
					<div id="div-half-left">
						<img src="<?php echo $this->asset?>img/wallpaper/capa_doom.jpg" width="100%">
					</div>
		...
		<section>
			...
			<div id="div-game" style="margin-bottom:50px;">
				...
				<img src="<?php echo $this->asset?>img/1.jpg" id="scream" width="500" height="350" style="display:none;">
				<audio id="a" src="<?php echo $this->asset?>sounds/sounds2.mp3"></audio>
			</div>
		</section>
		<section id="news-section">
			<article>
				...
				<div class='col-lg-8 col-lg-offset-2' style='heigth:500px;'>
					<div class='news-bottom'>
						<div class='foto-news'>
							<a href="<?php echo $this->url?>News/index/<?php echo $news->getIdNews();?>"><img src="<?php echo $this->asset?><?php echo $news->getImg();?>" style='width:100%;height:100%;'></a>
						</div>
						<div class='items-news'>
							<a href="<?php echo $this->url?>News/index/<?php echo $news->getIdNews();?>" class='item-news-h1'><h3 class='item-news-h1'><?php echo $news->getTitulo();?></h3></a>
							<p class='item-news-p'><?php echo substr($news->getDescripcion(),0,250)?></p>
							<a href="<?php echo $this->url?>News/index/<?php echo $news->getIdNews();?>" class='news-link'>VER NOTICIA</a>
						</div>
					</div>
				</div>
				<?php endforeach;?>
		...
		<!-- END SCRIPT JSSOR-->
		<script  type="text/javascript" src="<?php echo $this->asset?>js/fundo.js"></script>
		<script  type="text/javascript" src="<?php echo $this->asset?>js/personaje.js"></script>
		<script type="text/javascript" src="<?php echo $this->asset?>js/enemigo.js"></script>
		<script type="text/javascript" src="<?php echo $this->asset?>js/smile.js"></script>
		<script  type="text/javascript" src="<?php echo $this->asset?>js/base.js"></script>
	</body>
</html>